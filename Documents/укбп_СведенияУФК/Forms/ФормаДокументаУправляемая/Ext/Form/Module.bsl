...
Процедура Подбор(Команда)
	...
	//ПараметрыОткрытия = Новый Структура("Ключ", Истина);
	ПараметрыОткрытия = Новый Структура("АдресСхемы", АдресСхемы);
	ОткрытьФорму("Документ.укбп_СведенияУФК.Форма.ФормаПодбора", ПараметрыОткрытия, ЭтаФорма);	
